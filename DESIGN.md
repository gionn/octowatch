...
10. **Enhanced Token Validation**: Support for all GitHub token formats (classic, ghp*, github_pat*, etc.)
...
_This design document reflects the current implementation as of October 2025._
